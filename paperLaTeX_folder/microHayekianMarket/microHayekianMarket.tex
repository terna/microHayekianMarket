...
If $nBuyers \gg nSellers$ (e.g., $nBuyers=100$ and $nSellers=30$, as in Fig. \ref{output_2_0a.png}), we observe in that Figs. \ref{output_3_1a.png} and \ref{output_3_2a.png} the prices are higher than in Figs. \ref{output_3_1.png} and \ref{output_3_2.png}. We have alway $seed=100$.
