...
\begin{figure}[htbp]
\begin{center}
\fbox{\centering \includegraphics[width=0.6\textwidth]{output_2_0.png}}
...
With $nBuyers \gg nSellers$ (e.g., $nBuyers=100$ and $nSellers=50$, as in Fig. \ref{output_2_0a.png}), we have two possible path of analysis. 
...
We can observe that in Figs. \ref{output_3_1a.png} and \ref{output_3_2a.png} the prices are---in the end---lower than in Figs. \ref{output_3_1.png} and \ref{output_3_2.png} and, must of all, the price tendence has a strong negative slope. We have always $seed=111$.

This result is inconsistent with the microeconomic theory, where an excess of demand is supposed to increase the prices.

\begin{figure}[htbp]
\begin{center}
\fbox{\centering \includegraphics[width=0.6\textwidth]{output_2_0a.png}}
...
With $nBuyers \ll nSellers$ (e.g., $nBuyers=50$ and $nSellers=100$, as in Fig. \ref{output_2_0b.png}), we have two possible path of analysis. 
...
We can observe that in Figs. \ref{output_3_1b.png} and \ref{output_3_2b.png} the prices are---in the end---greater than in Figs. \ref{output_3_1.png} and \ref{output_3_2.png} and, must of all, the price tendence has a strong positive slope. We have always $seed=111$.
...
\begin{figure}[htbp]
\begin{center}
\fbox{\centering \includegraphics[width=0.6\textwidth]{output_2_0b.png}}
