...
The note introduces in Section \ref{The hayekian version} a very simple agent-based model of a market, with emergent (quite interesting)  price dynamics.
...
In the Appendices, we have some technical analyses of the cases with unmatching numbers of buyers and sellers. These analyses are strongly related the the \href{https://terna.github.io/oligopoly/}{Oligopoly} simulation project.
\end{abstract}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
def warmingUp():
    global nCycles, nBuyers, nSellers,\
        ...
        usingRatios, d0, d1, d2, buyerPriceList, sellerPriceList
