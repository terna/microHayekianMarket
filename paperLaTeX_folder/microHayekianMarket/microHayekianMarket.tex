...
If $nBuyers \gg nSellers$ (e.g., $nBuyers=100$ and $nSellers=50$, as in Fig. \ref{output_2_0a.png}), we observe in that Figs. \ref{output_3_0a.png} and \ref{output_3_2a.png} the prices are higher than in Figs. \ref{output_3_1.png} and \ref{output_3_2.png}.
...
If $nBuyers \ll nSellers$ (e.g., $nBuyers=50$ and $nSellers=100$, as in Fig. \ref{output_2_0b.png}), we observe in that Figs. \ref{output_3_1b.png} and \ref{output_3_2b.png} the prices are lower than in Figs. \ref{output_3_1.png} and \ref{output_3_2.png}.
