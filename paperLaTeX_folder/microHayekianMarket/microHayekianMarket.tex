...
Always with Fig. \ref{output_3_1a.png} as starting configuration of the prices, Fig.s \ref{output_3_2aa.png} and \ref{output_3_3aa.png} @@@
...
squeeze
We always have $d_0=0.1$, $d_1=0.2$,  $d_2=0.2$, and $seed=111$.
...
As in Section \ref{nBuyers > nSellers with unequal rates of per-capita correction, with equivalent effects}, the novelty is that having $usingRatios=True$ we are activating limitations to $d_1$ or $d_2$.
