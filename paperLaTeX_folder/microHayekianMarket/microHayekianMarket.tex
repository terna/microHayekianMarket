...
\label{The model in the simplified hayekian perspective}
...
\label{Warming up for the corrupted version}
\begin{lstlisting}[language=Python, caption=Warming up for the corrupted version of the model, basicstyle=\ttfamily\footnotesize]
...
\label{The model in the corrupted simplified hayekian perspective}
\begin{lstlisting}[language=Python, caption=The model in the corrupted simplified hayekian perspective, basicstyle=\ttfamily\footnotesize]
a
\end{lstlisting}

Also listing \ref{The model in the simplified hayekian perspective} is modified to build Listing \ref{The model in the corrupted simplified hayekian perspective}, where the counter of each agent records
